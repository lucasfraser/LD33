 ...
 */
public class LakeRight extends Entity {

    public LakeRight(float x, float y, World world, Lighting lighting){
        super(false, x, y, 1, 1, world, lighting, true, Images.lakeRight, false);
    }
}
